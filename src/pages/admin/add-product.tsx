    ...
    return (
        <LayoutAdmin>
            <Container className="page-section relative" >
                ...
                <h2 className="mb-2 text-3xl font-bold">Add Product</h2>
                <p className="mb-6 text-sm text-slate-500 dark:text-slate-300">Use the same product logic, now wrapped in a cleaner admin form surface.</p>
