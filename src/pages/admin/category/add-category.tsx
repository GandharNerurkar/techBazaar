...
const AddCategory = () => {
  ...
  return (
    <LayoutAdmin>
        <Container className="page-section relative" >
            <div className="hero-surface grid grid-cols-1 sm:grid-cols-2 p-6 md:p-8" > 
                <div className="" >
                    <form action="" onSubmit={handleSubmit} method="post" encType="multipart/form-data" >
                        <p className="pill-badge mb-4">Admin Form</p>
                        <h2 className="mb-2 text-3xl font-bold">Add Category</h2>
                        <p className="mb-6 text-sm text-slate-500 dark:text-slate-300">Create polished category entries without changing any existing category logic.</p>
                        <CustomInput 
                            label="Category Name" 
                        ...
                        <Button className='!mt-5 !rounded-full !bg-gradient-to-r !from-blue-600 !to-cyan-500 !px-6 !py-3' type={"submit"}>
                            Add Category
                        </Button>
                    </form>
                </div>
