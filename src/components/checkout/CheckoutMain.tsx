...
const CheckoutMain = ({addresses, items} : any) => {
  ...
  return (
            <div>
                <div className="mb-6">
                    <p className="pill-badge mb-4">Checkout</p>
                    <h1 className="mb-2 text-3xl font-semibold" >Shipping Address</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-300">Review delivery details and place your order without changing the existing order flow.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4" >
                    ...
                    <div className="col-span-1" >
                        <div className="glass-card rounded-[28px] py-5 px-6 mb-3" >
                        ...
                        <div className="mt-4" >
                            <button onClick={()=> setOpenConfirmationPopup(true)} className="primary-button w-full" >Place Order</button>
                        </div>
